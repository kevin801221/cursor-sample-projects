...
> 程式碼在 `./company-mcp-server/`，遙控器 `demo.sh` 就放在這份文件旁邊（`project-10/demo.sh`）。整堂課的指令只有一個：
...
```bash
cd /path/to/project-10
pwd
# 把輸出複製到 args 中，例如 /Users/kevin/cursor-class-2/project-10
```
