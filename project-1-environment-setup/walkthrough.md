...
> 診斷工具與遙控器為 `./demo.sh`（位於 `project-1-environment-setup/` 根目錄）。
...
| 0:45–1:00 | 第 3 幕：全自動健康診斷 ⭐ | `./demo.sh 3` | `project-1-environment-setup/doctor.py` | 全綠色的終端機診斷卡片，提示全數 core 工具就緒 | 課前診斷與地基健全 |
